...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="utilities-color.html">Rawat Inap</a>
            <a class="collapse-item" href="utilities-border.html">Tempat Tidur</a>
            <a class="collapse-item" href="utilities-animation.html">Ruang ICU</a>
      ...
      <li class="{{ (Request::is('pendaftaran')) ? 'nav-item active' : 'nav-item' }}">
