...
@section('content')
 ...
 <div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary float-left mt-1">Detail Registrasi <?= $pasien->nama_pasien ?></h6>
         ...
         <table class="table table-bordered table-hover">
          <thead>
           ...
           <tr>
            ...
            <td>{{ $registrasi->alamat_pasien }}</td>
           </tr>
           <tr>
